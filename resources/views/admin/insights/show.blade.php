...
@section('content')
    ...
    <div class="grid-container">
      ...
      <div class="grid-x grid-margin-x">
        <div class="cell medium-12">
          <p class="nav-return hide-for-medium"><a href="{{ url('/admin/insights') }}#mobile">Return to edit</a></p>
          <p class="nav-return show-for-medium"><a href="{{ url('/admin/insights') }}">Return to edit</a></p>
        </div> <!-- .cell .medium-12 -->
      </div> <!-- .grid-x .grid-margin-x -->
    </div> <!-- .grid-container -->
    </div> <!-- #article-title -->

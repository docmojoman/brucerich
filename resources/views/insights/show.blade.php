    ...
    <div class="grid-container">
      <div class="grid-x grid-margin-x">
        <div class="cell medium-9">
          ...
          <!-- <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. In ipsa adipisci, aperiam numquam quidem asperiores error repellat veniam, delectus aspernatur aut laborum sint itaque. Illo dolor dolorum distinctio asperiores nulla.</p> -->
